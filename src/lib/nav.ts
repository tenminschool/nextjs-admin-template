...
import { FileText, Layers, LayoutDashboard, LayoutGrid } from 'lucide-react';
...
export const NAV: NavCategory[] = [
  ...
  // Placeholder section — delete it (and `app/(dashboard)/menu-*/`) once real
  // features land.
  {
    category: 'Examples',
    items: [
      { label: 'Menu 1', href: '/menu-1', icon: LayoutGrid },
      { label: 'Menu 2', href: '/menu-2', icon: Layers },
      { label: 'Menu 3', href: '/menu-3', icon: FileText },
    ],
  },
];
